...
function ShowStudent(props) {
  ...
  const deleteStudent = (id) => {
    setShowLoading(true);
    const student = { studentNumber:data.studentNumber,firstName: data.firstName, lastName: data.lastName, city: data.city,
      email: data.email, password: data.password, courses:data.courses };
