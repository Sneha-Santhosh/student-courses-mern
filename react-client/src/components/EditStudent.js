...
function EditStudent(props) {
  ...
  const updateStudent = (e) => {
    ...
    const data = { studentNumber:student.studentNumber,firstName: student.firstName, lastName: student.lastName, city:student.city,
      email: student.email,courses: student.courses };
      ...
      <Jumbotron>
        ...
        <Form.Group>
          ...
          <Form.Group>
            ...
            <Form.Control type="text" name="courses" id="username" placeholder="Enter courses" value={student.courses} onChange={onChange} />
          </Form.Group>
